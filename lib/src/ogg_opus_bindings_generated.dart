...
class OggOpusBindings {
  ...
  double ogg_opus_player_get_current_time(
    ffi.Pointer<ffi.Void> player,
      ...
      _ogg_opus_player_get_current_time(
        player,
      );
  ...
  void ogg_opus_player_set_playback_rate(
    ...
    double rate,
      ...
      _ogg_opus_player_set_playback_rate(
        player,
        rate,
      );
  ...
  late final _ogg_opus_player_set_playback_ratePtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
            ...
            ffi.Double,
          )>>("ogg_opus_player_set_playback_rate");
  ...
  void ogg_opus_player_initialize_dart(
    ffi.Pointer<ffi.Void> native_port,
      ...
      _ogg_opus_player_initialize_dart(
        native_port,
      );
  ...
  void ogg_opus_recorder_get_wave_data(
    ...
    ffi.Pointer<ffi.Int64> wave_data_length,
      ...
      _ogg_opus_recorder_get_wave_data(
        recoder,
        wave_data,
        wave_data_length,
      );
  ...
  late final _ogg_opus_recorder_get_wave_dataPtr = _lookup<
      ffi.NativeFunction<
          ...
          )>>("ogg_opus_recorder_get_wave_data");
  ...
  double ogg_opus_recorder_get_duration(
    ffi.Pointer<ffi.Void> recoder,
      ...
      _ogg_opus_recorder_get_duration(
        recoder,
      );
